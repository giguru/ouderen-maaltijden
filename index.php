...
$actieTeamEmail = "actieteamparticipatiekeuken@gmail.com";
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a target="_blank" class="nav-link" href="<?php echo $donateLink; ?>">Doneer</a>
                    </li>
                    <li class="nav-item">
                        <a target="_blank" class="nav-link" href="#offer-help">Ik wil helpen!</a>
                    </li>
                    <li class="nav-item">
                        <a target="_blank" class="nav-link" href="#join-the-team">Join the team</a>
                    </li>
                    <li class="nav-item">
    ...
    <main>
        ...
        <section class="text-center container" id="offer-help">
            <h2>Ik wil helpen!</h2>
            <p class="subtitle">Hoe kan ik helpen?</p>
            <div class="row">
                <div class="col-sm-4">
                    <img class="image-block" src="assets/images/volunteer-icon.png" />
                ...
                <div class="col-sm-4">
                    ...
                    <a target="_blank" class="btn btn-lg btn-bordeaux" href="<?php echo $donateLink; ?>">
            ...
            <div class="row">
                ...
                <div class="col-sm-6" id="contact">
                    ...
                    <p>
                        ...
                        <br/>
                        Email: <a target="_blank" href="mailto:<?php echo $infoEmail; ?>"><?php echo $infoEmail; ?></a>
                    </p>

                    <p>
                        <span class="font-weight-bold">Logistiek</span>
                        <br/>
                        Email: <a target="_blank" href="mailto:<?php echo $actieTeamEmail; ?>"><?php echo $actieTeamEmail; ?></a>
                    </p>
                    <a href="https://www.linkedin.com/company/de-participatiekeuken/">
                        <img src="./assets/images/social-linkedin-circle-512.png" class="social-logo" />
                    </a>
                    <br />
                    <br />
